 ...
 * - EthersAdapter: EVM wallets (MetaMask, Reown AppKit connections) via the
 *   JSON-RPC relay — requires an ECDSA account
 * - HashPackAdapter: native Hedera transactions signed through HashConnect —
 *   works with any account key type (ED25519 or ECDSA)
 *
